...
import { BarChart3, FileText, Gauge, Lightbulb, PlusCircle, Settings, Sparkles } from "lucide-react";
...
const navItems = [
  ...
  { href: "/settings", label: "方向设置", icon: Settings }
];
    ...
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 border-r border-slate-200 bg-white/92 px-4 py-5 backdrop-blur lg:block">
      <Link href="/" className="mb-8 flex items-center gap-3 px-2">
        ...
        <div>
          ...
          <div className="text-xs text-slate-500">思想资产管理系统</div>
        </div>
      </Link>
